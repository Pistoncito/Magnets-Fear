...
function refreshSpheres()
{
	...
	*/
	...
	if(player.id===0)
		{
		serverProyectiles[0].x= proyectiles[0].PhaserObject.body.x;
		serverProyectiles[0].y= proyectiles[0].PhaserObject.body.y;
		serverProyectiles[0].vx= proyectiles[0].PhaserObject.body.velocity.x;
		serverProyectiles[0].vy= proyectiles[0].PhaserObject.body.velocity.y;
		serverProyectiles[0].polarity= proyectiles[0].PhaserObject.body.polarity.postive;
		
		serverProyectiles[1].x= proyectiles[1].PhaserObject.body.x;
		serverProyectiles[1].y= proyectiles[1].PhaserObject.body.y;
		serverProyectiles[1].vx= proyectiles[1].PhaserObject.body.velocity.x;
		serverProyectiles[1].vy= proyectiles[1].PhaserObject.body.velocity.y;
		serverProyectiles[1].polarity= proyectiles[1].PhaserObject.body.polarity.positive;

		}
	
	else if(player.id===1)
		{
		proyectiles[0].PhaserObject.body.x = serverProyectiles[0].x;
		proyectiles[0].PhaserObject.body.y = serverProyectiles[0].y;
		proyectiles[0].PhaserObject.body.velocity.x = serverProyectiles[0].vx;
		proyectiles[0].PhaserObject.body.velocity.y = serverProyectiles[0].vy;
		proyectiles[0].PhaserObject.body.polarity.positive = serverProyectiles[0].polarity;
		
		if(proyectiles[0].PhaserObject.body.polarity.positive === 1)
			{
			proyectiles[0].PhaserObject.animations.play('positive');
			
			}else if(proyectiles[0].PhaserObject.body.polarity.positive === 0)
				{
				proyectiles[0].PhaserObject.animations.play('negative');
				}
		
		proyectiles[1].PhaserObject.body.x = serverProyectiles[1].x;
		proyectiles[1].PhaserObject.body.y = serverProyectiles[1].y;
		proyectiles[1].PhaserObject.body.velocity.x = serverProyectiles[1].vx;
		proyectiles[1].PhaserObject.body.velocity.y = serverProyectiles[1].vy;
		proyectiles[1].PhaserObject.body.polarity.positive = serverProyectiles[1].polarity;
		
		if(proyectiles[1].PhaserObject.body.polarity.positive === 1)
		{
		proyectiles[1].PhaserObject.animations.play('positive');
		
		}else if(proyectiles[1].PhaserObject.body.polarity.positive === 0)
			{
			proyectiles[1].PhaserObject.animations.play('negative');
			}
