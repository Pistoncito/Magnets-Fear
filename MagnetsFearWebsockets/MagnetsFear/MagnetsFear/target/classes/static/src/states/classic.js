...
MagnetsFear.classicState.prototype = {
    ...
    create: function() {
        ...
        esfera1 = new Sphere();
        esfera2 = new Sphere();
        initSphere1(player.x, player.y, 'sphere1');
        initSphere2(opponent.x, opponent.y, 'sphere2');
    ...
    initProyectiles: function(num){
    	for(i=0; i< num; i++)
	    {	
    			proyectiles[i]= new Proyectile(proyectiles.create(serverProyectiles[i].x, serverProyectiles[i].y,'proyectileSpSheet'));
    ...
    spawnBases: function (){
      ...
      for(i=0; i< n_bases; i++)
            {
              var posX1 = serverBases1[i].x;
              var posY1 = serverBases1[i].y;

              bases1[i]= new Bases(bases1.create(posX1, posY1, 'civilization1'));
              ...
              var posX2 = serverBases2[i].x;
              var posY2 = serverBases2[i].y;
              bases2[i]= new Bases(bases2.create((posX2), (posY2),'civilization2'));
